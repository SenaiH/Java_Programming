...
public class Task_7_MonthNumber {
    public static void main(String[] args) {
      int month = -10;          // String months = "";
      if(month>=1&&month<=12){
          if(month==1) System.out.println("January");  // month = January;
           else if (month==2) System.out.println("February"); // month = February;
