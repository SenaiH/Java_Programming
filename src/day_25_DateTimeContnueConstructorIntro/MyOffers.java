...
public class MyOffers {
    public static void main(String[] args) {
        ...
        Offer offer1 = new Offer();  // Number 1
        ...
        offer6.setInfo("WA", "Bank Of America", "BA", 130_000, true, true, false, true);

        Offer offer7 = new Offer();
        offer7.setInfo("TX", "CapitalOne", "SM", 115000, false, false, true, true);
        ...
        Offer[] myOffers = {offer1, offer2, offer3, offer4, offer5,offer6,offer7};  // Number 2
        ...
        devOffers.removeIf(p->p.jobTitle!="developer");

        ArrayList<Offer>With100K = new ArrayList<>(Arrays.asList(myOffers));
        With100K.addAll(Arrays.asList(myOffers));
