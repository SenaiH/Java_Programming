...
public class LocalDateIntro {
    public static void main(String[] args) {
        ...
        System.out.println(  LocalDate.of(2023,3,15).isLeapYear());
        System.out.println(  LocalDate.of(2022, 6, 16).isLeapYear());
        System.out.println(  LocalDate.of(2021, 6, 16).isLeapYear());
        System.out.println(  LocalDate.of(2020, 6, 16).isLeapYear());
    }
