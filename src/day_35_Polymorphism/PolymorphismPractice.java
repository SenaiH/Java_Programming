...
import day_34_Interface.car1Task.AutoPark;
import day_34_Interface.car1Task.AutoPilot;
import day_34_Interface.car1Task.CydeoCar;
...
public class PolymorphismPractice {
    public static void main(String[] args) {
        ...
        Car car = new Tesla("Tesla", "Model Y", 2020, 55000);
