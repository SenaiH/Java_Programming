...
public class Task_3 {
    public static void main(String[] args) {
        String[] items  = {"Shoes", "Jacket","AirPods",  "Gloves", "AirPodsX", "iPad", "iPhone 12 case" };
        double[] prices = {99.99,      150.0,  9.99,     250.0 ,    439.50,  39.99,60.00};
        int[] itemIDs =   {12345 ,     12346,  12347,    12348,     12349,    12350,45632};
